...
// const Footer = () => {
//     const { iconColor, isRecording, toggleState, downloadTranscripts } = useContext(UserContext);
...
//                 {/* Download Icon */}
//                 <BsDownload
//                     className={`text-[30px] sm:text-[30px] md:text-[35px] lg:text-[45px] ${iconColor ? "text-white" : "text-[#6D4885]"}`}
//                 />
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-6 pt-0 pb-3 text-center md:px-16 lg:px-24">
      <div className="flex flex-wrap items-center justify-between w-full gap-4 md:gap-8 lg:gap-16">
        {/* Download Icon */}
        <BsDownload
          onClick={downloadTranscripts} // Add onClick to trigger the download
          className={`text-[30px] sm:text-[30px] md:text-[35px] lg:text-[45px] ${iconColor ? "text-white" : "text-[#6D4885]"}`}
